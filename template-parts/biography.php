...
$author_info = get_the_author_meta('starter_write_by');
$facebook_url = get_the_author_meta('starter_facebook');
$twitter_url = get_the_author_meta('starter_twitter');
$linkedin_url = get_the_author_meta('starter_linkedin');
$instagram_url = get_the_author_meta('starter_instagram');
$starter_url = get_the_author_meta('starter_youtube');
$starter_write_by = get_the_author_meta('starter_write_by');
